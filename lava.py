...
# 你的Lavanet节点RPC URL
LAVANET_RPC_URL = 'https://eth1.lava.build/lava-referer-74873735-1631-4095-b955-4e26e95780a5/'
...
def get_eth_balance(address):
    ...
    try:
        # 发起POST请求
        response = requests.post(LAVANET_RPC_URL, headers=headers, data=json.dumps(payload))
...
with open('wallet.csv', 'r') as csvfile:
    ...
    for row in reader:
        address = row[0]
        balance_wei = get_eth_balance(address)
